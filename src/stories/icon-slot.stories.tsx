...
const meta: Meta<typeof IconSlot> = {
  title: "Platform Components/Interaction Patterns/IconSlot",
  component: IconSlot,
  args: {
    position: "left",
    className: "h-5 w-5",
  ...
  render: (args) => (
    <div className="grid gap-3 text-foreground">
      <div className="flex items-center gap-2">
        <IconSlot {...args} position="left" className={args.className ?? "h-4 w-4"}>
          <Sparkles />
        </IconSlot>
      ...
      <div className="flex items-center gap-2">
        ...
        <IconSlot {...args} position="right" className={args.className ?? "h-4 w-4"}>
          <ArrowRight />
        </IconSlot>
      </div>
    </div>
...
export const Sizes: Story = {
  render: (args) => (
    <div className="flex items-center gap-4 text-foreground">
      <IconSlot {...args} className="h-3 w-3">
        <Sparkles />
      </IconSlot>
      <IconSlot {...args} className="h-5 w-5">
        <Sparkles />
      </IconSlot>
      <IconSlot {...args} className="h-7 w-7">
        <Sparkles />
      </IconSlot>
    </div>
  ),
